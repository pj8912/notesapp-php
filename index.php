...
<div class="container">
	...
	<!-- <div class="mt-5" style="display:flex;flex-direction:row">
			...
			<a class="h4 texts btn btn-success rounded-5 m-1" href="notebooks/create.php" >
	...
	<a class="h4 texts btn btn-success rounded-5 m-1" href="notebooks/create.php" >
		...
		<p class="text-secondary text-center" style="margin-top:100px;">No notebook created</p>
	</div>
