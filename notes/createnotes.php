    ...
    <div class="box1 fullnav">
        ...
        <div class="navbar">
            ...
            <div class="nav justify-content-end">
                ...
                <a style="" class="btn btn-danger ml-auto rounded-5 btn-sm  m-1" data-bs-toggle="tooltip" data-bs-placement="bottom" title="delete book" href="deletebooks.php?bid=<?php echo $bid;?>">
