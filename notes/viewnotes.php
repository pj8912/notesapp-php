...
?>
        ...
        if (isset($_REQUEST['bid'])) {
            ...
            while ($row  = $response->fetchArray(SQLITE3_ASSOC)) {
				...
				<div class="nav justify-content-end">
					  <a style="" class="btn btn-danger ml-auto rounded-5 btn-sm  m-1" data-bs-toggle="tooltip" data-bs-placement="bottom" title="delete book" href="deletebooks.php?bid='.$bid.'">
	...
	<a href="deleteNotes.php?nid='.$row['n_id'].'&bid='.$row['book_id'].'&uri='.$_SERVER['REQUEST_URI'].'" class="btn btn-light rounded-5">
